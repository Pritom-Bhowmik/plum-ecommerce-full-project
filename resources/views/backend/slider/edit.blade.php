                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form id="form" role="form" action="{{route('backend.content.slider.update', $edit->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                
                                <div class="form-group">
                                    <label>Title:</label>
                                    <textarea type="text" class="form-control" name="title" rows="3">{{old('title', $edit->title)}}</textarea>
                                    @error('title')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="position" value="{{old('position', $edit->position)}}">
                                    @error('position')
                                        <span class="error-message">{{$message}}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group d-block">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-md-6">
                                            <br>
                                            @if($edit->thumbnail)
                                            <img class="img-thumbnail" src="{{asset('/frontend/img/main-sliders/home-1/'.$edit->thumbnail)}}">
                                            @else
