            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="panel panel-default">
                        <div class="panel-heading"><h3 class="panel-title">Create a new admin</h3></div>
                        <div class="panel-body">
                            <form id="form" role="form" action="{{route('backend.users.create')}}" method="post" enctype="multipart/form-data">
                                @csrf
                ...
                <div class="col-md-4">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="">
                                <div class="">
                                    <img id="preview_avatar" class="img-thumbnail" src="https://via.placeholder.com/200x200" data-src="https://via.placeholder.com/200x200" alt="" style="max-width:250px;">
                                    <br>
    ...
    $.ajax({
        ...
        success:function(res){
            ...
            if(!res.status && Object.keys(res.errors).length > 0){
                ...
                $('#form')[0].reset();
                $('#preview_avatar').attr('src', $('#preview_avatar').data('src'));
                $('#avatar_name').text('');
            }
        },
        error:function(res){
