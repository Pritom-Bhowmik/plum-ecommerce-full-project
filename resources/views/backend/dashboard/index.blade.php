            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 col-lg-3">
                    <div class="mini-stat clearfix bx-shadow">
                        <span class="mini-stat-icon bg-info"><i class="md md-image"></i></span>
                        ...
                        <div class="tiles-progress">
                            <div class="m-t-20">
                                <h5 class="text-uppercase">Logos <span class="pull-right">60%</span></h5>
                ...
                <div class="col-md-6 col-sm-6 col-lg-3">
                    <div class="mini-stat clearfix bx-shadow">
                        ...
                        <div class="tiles-progress">
                            <div class="m-t-20">
                                <h5 class="text-uppercase">Downloads <span class="pull-right">90%</span></h5>
                                <div class="progress progress-sm m-0">
