...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Team Member</h4>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading content-between">
                            ...
                            <a class="btn btn-primary" href="{{route('backend.content.team.create')}}">Add New</a>
                        </div>
                        <div class="panel-body">
                            ...
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    @foreach(\App\Models\Team::orderBy('id', 'desc')->get() as $row)
                                    <tr>
                                        <td>{{$loop->index+1}}</td>
                                        <td><img class="img-thumbnail" style="width:60px;" src="{{asset('/frontend/img/team/'.$row->avatar)}}"></td>
                                        <td>{{ $row->name }}</td>
                                        <td>{!! $row->designation !!}</td>
                                        <td>
                                            <a class="btn btn-warning" href="{{route('backend.content.team.edit', $row->id)}}">Edit</a>
                                            <a class="btn btn-danger" onclick="return confirm('Are your sure? delete this row.');" href="{{route('backend.content.team.delete', $row->id)}}">Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
