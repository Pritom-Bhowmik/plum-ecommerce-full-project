...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Blogs</h4>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading content-between">
                            ...
                            <a class="btn btn-primary" href="{{route('backend.blog.create')}}">Add New</a>
                        </div>
                        <div class="panel-body">
                            ...
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$loop->index+1}}</td>
                                        <td><img class="img-thumbnail" style="width:60px;" src="{{asset('/frontend/img/blog/'.$row->thumbnail)}}"></td>
                                        <td>{{ $row->title }}</td>
