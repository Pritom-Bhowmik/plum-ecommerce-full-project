...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">All About Us</h4>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    @foreach(\App\Models\About::get() as $row)
                                    <tr>
                                        <td>{{$loop->index+1}}</td>
                                        <td><img class="img-thumbnail" style="width:140px;" src="{{asset('/frontend/img/about/aboutus/'.$row->thumbnail)}}"></td>
                                        <td>{!! $row->title !!}</td>
                                        <td>{!! $row->content !!}</td>
                                        <td width="10%">
                                            <a class="btn btn-warning" href="{{route('backend.content.about.edit', $row->id)}}">Edit</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
